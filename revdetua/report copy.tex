...
\begin{figure}[h]
    ...
    \caption{Tempo de execução dos algoritmos de pesquisa exaustiva e heurística gulosa em.}
    \label{fig:exectime}
\end{figure}

% pode se meter aqui foto la do problema

% talvez deva meter algures um dos meus grafos, resolvidos com a cor de cada subset, e depois o corte ficava sem o risco e deixava o peso da aresta na mesma, idk
