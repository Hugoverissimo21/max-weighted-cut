...
Este gráfico apresenta a quantidade de operações realizadas pelos algoritmos de busca exaustiva e heurística gulosa em função do número de vértices dos grafos analisados. 

O gráfico do número de operações realizadas reflete a complexidade formal dos algoritmos, proporcionando uma análise prática que confirma a relação entre o crescimento do número de operações e a complexidade teórica previamente discutida.

A comparação entre essas duas abordagens permite não apenas visualizar a eficiência relativa

é de notar q n se nota diferencas de ops consoante o numero de arestas, isto pq o os algoritmos acabam por analisar todas as arestas, mesmo q tenham valor 0 fig \ref{fig:numeroops}
