...
% arranjar fontes sem ser wikipedia
...
% rever tudo se n mudei ns e isso e ingles e titulo e isso
\begin{algorithm}
    \raggedright
    ...
    \begin{algorithmic}[1]
        ...
        \Comment{Sort edges in descending order by weight}
        ...
        \State \Return S, T, \Call{calculate\_cut\_weight}{G, S}
    
    \end{algorithmic}
\end{algorithm}

\pagebreak
% pq a section estava a ficar antes do alg para ter mais texto idk why cuidado
